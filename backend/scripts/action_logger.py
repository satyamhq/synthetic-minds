"""
Action Logger.
Used to record agent actions during OASIS simulations for monitoring.
...
class PlatformActionLogger:
    ...
    def __init__(self, platform: str, base_dir: str):
        ...
        Args:
            ...
            base_dir: Base directory path for simulation
        """
...
class ActionLogger:
    """
    Action logger (backwards-compatible interface).
...
def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Get global logger instance (backwards-compatible)."""
