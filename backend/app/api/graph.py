"""
Graph API routes.
Adopts project context mechanism with server-side persistent state.
"""
...
# Get logger
logger = get_logger('synthetic_minds.api')
...
def _build_graph_impl():
    ...
    try:
        ...
        # Get configuration
        graph_name = data.get('graph_name', project.name or 'Synthetic Minds Graph')
        ...
        def build_task():
            ...
            build_logger = get_logger('synthetic_minds.build')
            try:
