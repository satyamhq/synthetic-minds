<template>
  <div class="main-view">
    ...
    <main class="content-area">
      ...
      <!-- Right Panel: Step 3 Simulation Run -->
...
// Retrieve maxRounds from query params on init
...
const handleGoBack = async () => {
  // Close running simulation before navigating back to Step 2
  ...
  try {
    // Attempt graceful simulation environment shutdown
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      // Check if process needs to be terminated
...
const handleNextStep = () => {
  // Handled directly by Step3Simulation
...
onMounted(() => {
  ...
  // Record maxRounds configuration
  if (maxRounds.value) {
