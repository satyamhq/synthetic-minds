<template>
  <div class="home-container">
    <!-- Top Navigation Bar -->
    <nav class="navbar">
      <div class="nav-brand">Synthetic Minds</div>
      <div class="nav-links">
        <LanguageSwitcher />
        <a href="https://github.com/satyamhq/synthetic-minds" target="_blank" class="github-link">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        ...
        <div class="hero-right">
          <!-- Text-only Hero Branding Showcase -->
          <div class="hero-brand-panel">
            <div class="brand-panel-tag">{{ $t('home.heroTitle1') }}</div>
            <div class="brand-display-text">SYNTHETIC<br />MINDS</div>
            <div class="brand-meta-pills">
              <div class="meta-pill"><span class="pill-dot"></span> LLM: OpenAI API</div>
              <div class="meta-pill"><span class="pill-dot"></span> Memory: Temporal Graph</div>
              <div class="meta-pill"><span class="pill-dot"></span> Engine: OASIS Social Sim</div>
            </div>
          </div>
      ...
      <!-- Lower Section: Two-Column Dashboard -->
...
// Start simulation - transition immediately, API execution on Process page
...
:root {
  ...
  */
  ...
  --font-sans: 'Space Grotesk', 'Noto Sans Devanagari', system-ui, sans-serif;
  --font-cn: 'Noto Sans Devanagari', system-ui, sans-serif;
}
