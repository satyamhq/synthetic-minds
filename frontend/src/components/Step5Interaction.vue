...
const chatHistoryCache = ref({}) // Cache conversation history: { 'report_agent': [], 'agent_0': [], 'agent_1': [], ... }
...
const renderMarkdown = (content) => {
  ...
  // Clean up <p><br> preceding block elements
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Clean up consecutive <br> tags
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Clean up <br> before paragraph after block elements
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix discontinuous ordered list numbering: keep incrementing when separated by paragraphs
