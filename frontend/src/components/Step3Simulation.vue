          ...
          >
            ...
            <div class="timeline-card">
              ...
              <div class="card-body">
                ...
                <!-- General Fallback: Unknown type or unhandled content -->
...
const runStatus = ref({})
const allActions = ref([]) // All actions (accumulative)
const actionIds = ref(new Set()) // Action ID set for deduplication
const scrollContainer = ref(null)

// Computed
// Display actions chronologically (latest at the bottom)
...
const resetAllState = () => {
  ...
  stopPolling()  // Stop previous polling if active
}
...
const doStartSimulation = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      startError.value = res.error || t('simulation.startFailed') || 'Failed to start simulation'
...
const fetchRunStatusDetail = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Do not auto-scroll, allow user to freely inspect timeline
